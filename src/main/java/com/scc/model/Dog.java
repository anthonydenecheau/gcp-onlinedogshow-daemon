...
//    		, @JsonProperty("affixe") String affixe
//    		, @JsonProperty("sexe") String sexe
//    		, @JsonProperty("dateNaissance") String dateNaissance
//    		, @JsonProperty("pays") String pays
//    		, @JsonProperty("tatouage") String tatouage
//    		, @JsonProperty("transpondeur") String transpondeur
//    		, @JsonProperty("codeFci") String codeFci
//    		, @JsonProperty("idRace") int idRace
//    		, @JsonProperty("idVariete") int idVariete
//    		, @JsonProperty("race") String race
//    		, @JsonProperty("variete") String variete
//    		, @JsonProperty("couleur") String couleur
//    		, @JsonProperty("idEtalon") int idEtalon
//    		, @JsonProperty("idLice") int idLice
//    ) {
//		super();
//		this.id = id;
//		this.nom = nom;
