...
import com.scc.service.BreederService;
import org.springframework.beans.factory.annotation.Autowired;
import com.scc.service.DogService;
import com.scc.service.OwnerService;
import com.scc.service.ParentService;
import com.scc.service.PedigreeService;
import com.scc.service.TitleEtrService;
import com.scc.service.TitleFrService;
...
public class DogScheduler {
    ...
    public void synchronizeDog() {
        ...
        try {
	    	...
	    	// IV. Lecture dans la table demande de synchro pour l'ensemble des titres (francais et étrangers) sur lesquels 1 maj est demandée
